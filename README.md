...
- Make the theme toggle affect all screens consistently
- Finalize change password validation and backend integration
- Implement and verify delete account flow
- Hide the "Pay with eSewa" button after successful payment in all relevant views
